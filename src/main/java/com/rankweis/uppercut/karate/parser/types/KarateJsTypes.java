...
public class KarateJsTypes {
  ...
  public static IElementType CONTINUE_STMT = new KarateJsElementType("CONTINUE_STMT");
  ...
  public static IElementType CLASS_EXPR = new KarateJsElementType("CLASS_EXPR");
  public static IElementType CLASS_MEMBER = new KarateJsElementType("CLASS_MEMBER");
  public static IElementType SUPER_EXPR = new KarateJsElementType("SUPER_EXPR");
  ...
  public static IElementType LOGIC_NULLISH_EXPR = new KarateJsElementType("LOGIC_NULLISH_EXPR");
  ...
  static {
    ...
    TYPE_TO_ELEMENT_TYPE.put(Type.CONTINUE_STMT, new KarateJsElementType("CONTINUE_STMT"));
    ...
    TYPE_TO_ELEMENT_TYPE.put(Type.CLASS_EXPR, new KarateJsElementType("CLASS_EXPR"));
    TYPE_TO_ELEMENT_TYPE.put(Type.CLASS_MEMBER, new KarateJsElementType("CLASS_MEMBER"));
    TYPE_TO_ELEMENT_TYPE.put(Type.SUPER_EXPR, new KarateJsElementType("SUPER_EXPR"));
    ...
    TYPE_TO_ELEMENT_TYPE.put(Type.LOGIC_NULLISH_EXPR, new KarateJsElementType("LOGIC_NULLISH_EXPR"));
